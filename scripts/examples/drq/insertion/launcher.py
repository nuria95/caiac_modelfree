...
_applicable_configs_disagreement_drq = {'alg': ['DisagreementDrQ'],
                                        ...
                                        'update_encoder_with_exploration_policy': [1],
                                        'predict_img_embed': [1],
                                        } | _applicable_configs
...
_applicable_configs_disagreement_max_ent_drq = {'alg': ['MaxEntDrQ'],
                                                'exploitation_switch_at': [0.75],
                                                'init_exploration_freq': [1],
                                                'train_ensemble_with_target': [1],
                                                'update_encoder_with_exploration_policy': [1],
...
all_flags_combinations = dict_permutations(_applicable_configs_drq) \
