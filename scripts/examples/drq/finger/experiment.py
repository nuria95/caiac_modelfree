...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', type=str, default='FingerImgTest')
    parser.add_argument('--alg', type=str, default='DisagreementDrQv2')
    ...
    parser.add_argument('--task', type=str, default='turn_hard')
