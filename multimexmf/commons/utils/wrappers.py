...
class HERGoalEnvWrapper(gym.Wrapper):
    ...
    def __init__(self, env):
        ...
        space_types = [type(env.observation_space.spaces[key])
    ...
    def step(self, action):
        ...
        return self.convert_dict_to_obs(obs), reward, terminated, truncated,  info
    ...
    def reset(self, **kwargs):
        ...
        obs = self.convert_dict_to_obs(dict_obs)
        return obs, info
